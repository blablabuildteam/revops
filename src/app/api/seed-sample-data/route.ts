  ...
  try {
    ...
    await sql`
      INSERT INTO opportunities (company_id, name, type, stage, probability, expected_value, actual_value, sentiment, proposal_status, owner, close_date, notes) VALUES
        ('11111111-1111-1111-1111-111111111111', 'CRM implementation Q3', 'project', 'proposal', 70, 54450, 0, 'positive', 'sent', 'Kevin', '2026-08-15', 'Client is enthusiastic, waiting on board go/no-go'),
        ('22222222-2222-2222-2222-222222222222', 'Data platform retainer', 'retainer', 'negotiation', 85, 10285, 0, 'very_positive', 'accepted', 'Kevin', '2026-07-30', 'Contract almost finalized'),
        ('33333333-3333-3333-3333-333333333333', 'SEO & Content strategy', 'new', 'qualified', 40, 21780, 0, 'neutral', 'draft', 'Kevin', '2026-09-01', 'First meeting went well')
    `;
